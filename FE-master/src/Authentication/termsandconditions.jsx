...
export default function Termsandconditions() {
  return (
    <div>
      <br></br>
      <br></br>
    <Container maxWidth="lg" sx={{textAlign:"left", boxShadow: "0 6px 18px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.4)",borderRadius:"1em",backgroundColor:"white"}}>
    <div>
      <h1>Terms and Conditions for Company Name</h1>
      <h1> Introduction</h1>
      These Website Standard Terms and Conditions written on this webpage shall
      manage your use of our website, Webiste Name accessible at Website.com.
      ...
      these Website Standard Terms and Conditions. Minors or people below 18
      years old are not allowed to use this Website. Intellectual Property
      Rights Other than the content you own, under these Terms, Company Name
      and/or its licensors own all the intellectual property rights and
      materials contained in this Website. You are granted limited license only
      ...
      showing any Website material; using this Website in any way that is or may
      be damaging to this Website; using this Website in any way that impacts
      user access to this Website; using this Website contrary to applicable
      laws and regulations, or in any way may cause harm to the Website, or to
      ...
      marketing. Certain areas of this Website are restricted from being access
      by you and Company Name may further restrict access by you to any areas of
      ...
      These Terms constitute the entire agreement between Company Name and you
